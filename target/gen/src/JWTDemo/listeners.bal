...
@docker:Config {
    ...
    @docker:CopyFiles {
        files: [
                ...
                {  sourceFile:"/Software_Development/Workspace/micro-gateway/product-microgateway/distribution/resources/conf/micro-gw.conf", 
                   target:"/Software_Development/Workspace/micro-gateway/product-microgateway/distribution/resources/conf/micro-gw.conf", 
